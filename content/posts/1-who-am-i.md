...
- [CYL](https://www.cylax.org/) Head/Assistant Coach Boys 2021 - Present
...
- [Lake Placid Summit Classic 40+](https://pllplay.com/tournaments/lake-placid-summit-classic/) 2026-Present
- [Richmond Summer League Lacrosse](https://www.richmondsummerlax.com/) 2019, 2021-2022
...
Every season, parents ask the same questions: who am I, what stick should my son start with, which brands are worth the money, and how should his gear fit. For years I answered with the same long email, rewritten each spring and fall. It was time to put those answers somewhere public, keep them current, and simply point people here.

Start with these three posts:

- [Boys Starter Sticks / Crosse]({{< relref "2-boys-starter-stick.md" >}}) — the one stick I recommend for every beginner, and why
- [Lax Brands]({{< relref "3-lax-brands.md" >}}) — which brands to trust and which to skip
- [Protection and Fit]({{< relref "4-protection-and-fit.md" >}}) — how to fit a helmet, gloves, and pads so they actually protect
